  ...
  return (
    <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-xl shadow-slate-200/60">
      <div className="mb-5 flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.3em] text-emerald-600">Cobertura</p>
          <h2 className="mt-2 text-2xl font-bold text-slate-950">Provincia Artemisa</h2>
          <p className="mt-1 text-slate-600">Selecciona un municipio disponible para entrar al catálogo local.</p>
        </div>
        <span className="rounded-full bg-orange-50 px-4 py-2 text-sm font-semibold text-orange-700">Entrega por municipio</span>
      </div>
