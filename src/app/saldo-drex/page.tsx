...
export default function WalletPage() {
  return (
    <main className="mx-auto max-w-6xl px-4 py-10 lg:px-8">
      ...
      <p className="mt-2 max-w-3xl text-slate-600">Billetera interna tipo débito para consultar saldo, movimientos y compras con balance disponible.</p>
      ...
      <section className="mt-8 grid gap-6 lg:grid-cols-[360px_1fr]">
        <aside className="demo-card p-6">
          ...
          <div className="mt-6 grid gap-3">
            <Link href="/demopay" className="btn-primary">Cargar saldo</Link>
            <button className="rounded-full bg-slate-950 px-5 py-4 font-black text-white">Transferir interno</button>
