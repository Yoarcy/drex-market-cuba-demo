    ...
    <main className="mx-auto flex max-w-5xl items-center justify-center px-4 py-12 lg:px-8">
      <section className="demo-card grid w-full overflow-hidden md:grid-cols-2">
        <div className="bg-gradient-to-br from-emerald-600 to-sky-600 p-8 text-white">
          ...
          <p className="mt-4 text-white/85">Acceso para compradores y beneficiarios. El panel administrativo vive en una entrada separada y protegida.</p>
          <div className="mt-8 rounded-2xl bg-white/15 p-4 text-sm font-semibold">Demo cliente: cliente@demo.local / demo123<br/>Demo beneficiario: beneficiario@demo.local / demo123</div>
        </div>
        <form className="p-8">
