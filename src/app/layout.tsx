...
export const metadata: Metadata = {
  ...
  icons: {
    ...
    apple: "/assets/brand/drex-market-mark.svg",
  },
};
        ...
        <div className="min-h-screen bg-[linear-gradient(180deg,#F0FDFA_0%,#F6F8FB_38%,#FFFFFF_100%)] text-slate-900">
          <header className="public-header sticky top-0 z-50 min-h-[72px] border-b border-slate-200 bg-white/58 shadow-sm shadow-slate-900/5 backdrop-blur-2xl supports-[backdrop-filter]:bg-white/50">
            ...
            <aside className="public-drawer">
              <div className="drawer-title"><img src="/assets/brand/drex-market-mark.svg" alt="DREX" className="drawer-logo-mark" /><div><strong>DREX Market</strong><p>Cuba Demo</p></div></div>
          ...
          <footer className="footer-dark border-t border-white/10 bg-slate-950 px-4 py-8 text-center text-sm font-semibold text-slate-300">
            <div className="footer-actions" aria-label="Contacto y ayuda">
              <a href="#" className="footer-icon-link" aria-label="WhatsApp"><img src="/assets/icons/21_whatsapp_transparent.png" alt="WhatsApp" /></a>
              <a href="#" className="footer-icon-link" aria-label="Correo"><img src="/assets/icons/22_correo_transparent.png" alt="Correo" /></a>
              <a href="#" className="footer-icon-link" aria-label="Preguntas frecuentes"><img src="/assets/icons/23_preguntas_frecuentes_transparent.png" alt="Preguntas frecuentes" /></a>
            </div>
