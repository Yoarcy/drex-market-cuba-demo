...
type WasteRecord = { id: string; productId: string; productName: string; quantity: number; cause: string; payer: string; chargeAmount: number; createdAt: string };
...
export default function AdminPage() {
  ...
  const [wasteForm, setWasteForm] = useState({ quantity: "", cause: "", payer: "Mensajero responsable" });
  ...
  const registerWaste = async () => {
    ...
    if (!wasteForm.cause.trim()) { alert("Escribe la causa de la merma."); return; }
